...
{
    [Serializable]
    public class BaseArchiveCommandHandler : BaseCommandHandler, IRequestHandler<BaseArchiveCommand, ServiceResponse<OperationResult>>
    {
        ...
        public async Task<ServiceResponse<OperationResult>> Handle(BaseArchiveCommand command, CancellationToken cancellationToken)
        {
