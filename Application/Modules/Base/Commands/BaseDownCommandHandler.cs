...
{
    [Serializable]
    public class BaseDownCommandHandler : BaseCommandHandler, IRequestHandler<BaseDownCommand, ServiceResponse<OperationResult>>
    {
        ...
        public async Task<ServiceResponse<OperationResult>> Handle(BaseDownCommand command, CancellationToken cancellationToken)
        {
