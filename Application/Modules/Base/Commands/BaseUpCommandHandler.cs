...
{
    [Serializable]
    public class BaseUpCommandHandler : BaseCommandHandler, IRequestHandler<BaseUpCommand, ServiceResponse<OperationResult>>
    {
        ...
        public async Task<ServiceResponse<OperationResult>> Handle(BaseUpCommand command, CancellationToken cancellationToken)
        {
