...
{
    [Serializable]
    public class CreateProductValidation : BaseValidation<CreateProductCommand>
    {
        public CreateProductValidation(IDbContext dbContext, IDefinitionModel definitionModel)
