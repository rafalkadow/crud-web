...
{
    [Serializable]
    public class CreateCategoryOfProductHandler : BaseCommandHandler, IRequestHandler<CreateCategoryOfProductCommand, OperationResult>
    {
        ...
        public async Task<OperationResult> Handle(CreateCategoryOfProductCommand command, CancellationToken cancellationToken)
        {
